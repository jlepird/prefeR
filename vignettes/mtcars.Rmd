---
title: "Using preference elicitation to identify a user's ideal car"
author: "Jack Lepird"
date: "`r Sys.Date()`"
...
If we wanted to give a user a list of their top five most perferred cars from the ```mtcars``` dataset, there are three approaches we could take:
...
3. Have the user compare a small number of alternatives, and derive their weights from those comparisions. 
